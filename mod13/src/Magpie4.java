...
public class Magpie4
{
    ...
    public String getResponse(String statement)
    {
        ...
        else
        {
            ...
            int positionMe = findKeyword(statement, "me", 0);
            int positionI = findKeyword(statement, "i", 0);

            if (positionYou >= 0 && positionMe >= 0)
            {
                response = transformYouMeStatement(statement);
            }
            else if (positionI >= 0 && positionYou >= 0)
            {
    ...
    private String getRandomResponse()
    {
        ...
        responses.add("Wow!");
        responses.add("I'm tired.");

        double r = Math.random();
        int whichResponse = (int)(r * responses.size());

        return responses.get(whichResponse);
    }
