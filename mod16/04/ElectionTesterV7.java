...
public class ElectionTesterV7
{
    ...
    private static void changeName(Candidate[] data, String oldName, String newName)
    {
        ...
        {
            if(data[i] != null && data[i].getName().equals(oldName))
            {
    ...
    private static void changeVotes(Candidate[] data, String name, int newVotes)
    {
        for(int i = 0; i < data.length; i++)
        {
            if(data[i] != null && data[i].getName().equals(name))
            {
    ...
    public static void removeCandidateByIndex(Candidate[] data, int index)
    {
    ...
    public static void removeCandidateByName(Candidate[] data, String find)
    {
        int location = 0;
        int i;

        for(i = 0; i < data.length; i++) {
            if ((data[i] != null) && (data[i].getName().equals(find)))
            {
                location = i;
                break;
            }
        ...
        if ((i != data.length) && (location >= 0))
        {
            for(i = location; i < data.length -1; i++) {
                data[i] = data[i + 1];
            }
