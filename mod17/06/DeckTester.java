...
public class DeckTester
{
    ...
    public static void main(String[] args)
    {
        ...
        String[] myRanks = {"queen","seven","ace","six","king","queen","four","five","nine","eight"};
        String[] mySuits = {"heart","diamond","spade","spade","heart","club","spade","diamond","heart","heart"};
        int[] myPointValues = {12,7,1,6,13,12,4,5,9,8};
