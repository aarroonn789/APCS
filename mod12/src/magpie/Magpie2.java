...
public class Magpie2
{
    ...
    public String getResponse(String statement)
    {
        ...
        else if (findKeyword(statement, "stanley", 0) >= 0
                || findKeyword(statement, "shelton", 0) >= 0)
        {
            response = "He sounds like a wonderful APCS teacher.";
        }
        else if (statement.trim().length() == 0)
        {
            response = "Say something, please.";
                ...
                || findKeyword(statement, "pizza", 0) >= 0)
        {
            response = "Italian food is fantastic.";
        }
        else if (findKeyword(statement, "candy", 0) >= 0
                || findKeyword(statement, "soda", 0) >= 0)
        {
            response = "Sugar is good in moderation.";
        }
        {
    ...
    private String getRandomResponse()
    {
        ...
        {
            response = "I can only imagine.";
        }
        else if (whichResponse == 5)
        {
            response = "It's cold in here...";
        }
